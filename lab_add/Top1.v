...
module ALU(	// src/main/scala/ALU.scala:4:7
  ...
  assign io_out =
    io_op == 4'h0
      ? io_b + 4'h5
      : (io_op[0] ?  io_b & 4'h5: 4'h0) | (io_op[1] ?  io_b ^ 4'h5: 4'h0)
        | (io_op[2] ? 4'h5 - io_b : 4'h0) | (io_op[3] ? _io_out_T_10[3:0] : 4'h0);	// src/main/scala/ALU.scala:4:7, :8:14, :17:{15,20}, :18:{12,20}, :20:12, :21:{12,25}, :22:{12,25}, :23:{12,25}, :24:{12,25}, src/main/scala/chisel3/util/Mux.scala:30:73
endmodule
